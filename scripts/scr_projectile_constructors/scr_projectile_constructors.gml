...
function SrcProjectileMissileCreate (_owner): ScrProjectileCreate() constructor {
 ...
 draw_rocket_flame = method(self, function(_owner) {
    ...
    var _flame_offset = -1; // distância da chama em relação ao foguete (atrás)

    // calcula o ponto atrás do foguete baseado no ângulo
